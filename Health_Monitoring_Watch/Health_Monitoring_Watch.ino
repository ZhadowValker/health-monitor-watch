...
char auth[] = "rP3GaX8cfZg8S-328aNV6dWvJo82gvnx"; //Enter your Authentication Token
...
const char* ssid = "wifi 2.4";   // insert your own ssid
const char* password = "m4n1f3s7";              // and password
String date;
String t;
String tempC;
